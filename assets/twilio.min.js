...
unmute:function(){this.mediaStream.attachAudio()},accept:function(a){if("function"==typeof a)return this.addListener("accept",a);var b=this;e.getClass("vendor/mediastream/mediastream","MediaStream");this._status="pending";this.mediaStream.openHelper(function(a,d){if(a)b._die(a,d);else{var n=[],c;for(c in b.message)n.push(c+"="+encodeURIComponent(b.message[c]));n=[b.mediaStream.uri(),b.options.token,b.options.bridgeToken,n.join("&")].concat(b.options.acceptParams);b.mediaStream.open.apply(b.mediaStream,
...
1;if(a in this.cache){a=this.cache[a];for(var b=0;b<a.sounds.length;b++)a.sounds[b].play(c,e);a.starttime=(new Date).getTime()}},stop:function(a){if(a in this.cache){var c=this.cache[a];a=c.envelope.release||0;var e=function(){for(var a=0;a<c.sounds.length;a++)c.sounds[a].stop()},b=(new Date).getTime(),b=Math.max(0,a-(b-c.starttime));0==a?e():setTimeout(e,b)}},envelope:function(a,c){if(a in this.cache){var e=this.cache[a],b;for(b in c)e.envelope[b]=c[b]}},playseq:function(){var a=null,c=[],e=function(){var b=
c.shift();if(b){var h=b[0],l=b[1]||0,b=b[2]||0;h in this.cache&&this.play(h);a=setTimeout(f(this,e),l+b)}else a=null};return function(b){for(var h=0;h<b.length;h++)c.push(b[h]);null==a&&(a=setTimeout(f(this,e),0))}}()};a.SoundCache=e};s["lib/twilio/state.js"]=function(k,a){var f,e,d,c,g,b={}.hasOwnProperty,h=function(a,c){function e(){this.constructor=a}for(var d in c)b.call(c,d)&&(a[d]=c[d]);e.prototype=c.prototype;a.prototype=new e;a.__super__=c.prototype;return a},l=[].indexOf||function(a){for(var b=
0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1},r=[].slice;g=function(a){return a.substr(0,1).toUpperCase()+a.slice(1)};c=function(a){var b,c,d;d=[];for(b in a)c=a[b],d.push(new e(b,c));return d};d=function(a){function b(){b.__super__.constructor.apply(this,arguments)}h(b,a);return b}(Error);e=function(){return function(a,b,c){this.froms=a;this.to=b;this.name=c;this.froms instanceof Array||(this.froms=[this.froms]);this.name=this.name||"do"+g(this.to)}}();f=function(){function a(b,
e,d){var f;this.ctx=null!=e?e:this;this.stateData=null!=d?d:[];e=c(b);if(0===e.length)throw Error("Must initialize with at least one transition");this.state=e[0].froms[0];this.stateData instanceof Array||(this.stateData=[this.stateData]);d=0;for(f=e.length;d<f;d++)b=e[d],this.makeEvent(b)}a.prototype.makeEvent=function(a){var b=this;return this[a.name]=function(){var c;if(c=b.state,0>l.call(a.froms,c))throw new d("Not a valid transition");b.stateData=b.invoke.apply(b,["leave",b.state,a].concat(r.call(b.stateData)));
b.stateData=b.invoke.apply(b,["enter",a.to,a].concat(r.call(b.stateData)));return b.state=a.to}};a.prototype.invoke=function(){var a,b,c,e,d;b=arguments[0];c=arguments[1];e=arguments[2];a=4<=arguments.length?r.call(arguments,3):[];b+=g(c);return this.ctx[b]?(a=(d=this.ctx)[b].apply(d,[e].concat(r.call(a))),"undefined"===typeof a&&(a=[]),a instanceof Array?a:[a]):a};return a}();a.TransitionError=d;a.Transition=e;a.StateM=f};s["lib/twilio/util.js"]=function(k,a){function f(a){if(!(this instanceof f))return new f(a);
this.message=a}function e(a){return function(){var b=Array.prototype.slice.call(arguments,0);a.memo=a.memo||{};return a.memo[b]?a.memo[b]:a.memo[b]=a.apply(null,b)}}function d(a){a=a.split(".");if(3!=a.length)throw new f("Wrong number of segments");return l(a[1])}function c(a){if(""==a)return{};if(-1==a.indexOf("&")&&-1==a.indexOf("="))return a;a=a.split("&");for(var b={},e=0;e<a.length;e++){var d=a[e].split("=");b[d[0]]=c(decodeURIComponent(d[1]))}return b}function g(a){try{return btoa(a)}catch(b){try{return(new Buffer(a)).toString("base64")}catch(c){return Twilio._phpjs_btoa(a)}}}
function b(a){try{return atob(a)}catch(b){try{return(new Buffer(a,"base64")).toString("ascii")}catch(c){return Twilio._phpjs_atob(a)}}}function h(a){var b=[],c;for(c in a){var e="object"==typeof a[c]?h(a[c]):a[c];b.push(encodeURIComponent(c)+"="+encodeURIComponent(e))}return b.join("&")}f.prototype.toString=function(){return"Twilio.Exception: "+this.message};var l=e(function(a){var c=a.length%4;0<c&&(a+=Array(4-c+1).join("="));a=a.replace(/-/g,"+").replace(/_/g,"/");a=b(a);return JSON.parse(a)}),
r=e(function(a){a=d(a);for(var b=0===a.scope.length?[]:a.scope.split(" "),e={},h=0;h<b.length;h++){var g;g=b[h].match(/^scope:(\w+):(\w+)\??(.*)$/);if(!(g&&4==g.length))throw new f("Bad scope URI");g={service:g[1],privilege:g[2],params:c(g[3])};e[g.service+":"+g.privilege]=g}a.scope=e;return a}),t=function(){function a(){this.set={}}a.prototype.clear=function(){this.set={}};a.prototype.put=function(b){return this.set[b]=a.DUMMY};a.prototype.del=function(a){return delete this.set[a]};a.prototype.map=
function(a,b){var c=[],e;for(e in this.set)c.push(a.call(b,e));return c};a.DUMMY={};return a}();a.encodescope=function(a,b,c){a=["scope",a,b].join(":");b=!0;for(var e in c){b=!1;break}return b?a:a+"?"+h(c)};a.dummyToken=function(a){var b={iss:"AC1111111111111111111111111111111",exp:14E8},c;for(c in b)a[c]=a[c]||b[c];a=g(JSON.stringify(a));a=a.replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_");return["*",a,"*"].join(".")};a.Exception=f;a.decode=d;a.btoa=g;a.atob=b;a.objectize=r;a.urlencode=function(a,
b){var c=[];b=b||!1;for(var e in a)if(b&&a[e]instanceof Array)for(var d in a[e]){var f=a[e][d];c.push(encodeURIComponent(e)+"="+encodeURIComponent(f))}else f=a[e],c.push(encodeURIComponent(e)+"="+encodeURIComponent(f));return c.join("&")};a.Set=t;a.bind=function(a,b){var c=Array.prototype.slice.call(arguments,2);return function(){var e=Array.prototype.slice.call(arguments);return a.apply(b,c.concat(e))}};a.getSystemInfo=function(){var a=k("twilio/factories"),b=k("twilio/rtc"),a=a.getClass("vendor/swfobject",
"swfobject"),c="undefined"!=typeof navigator?navigator:{},c={p:"browser",v:"1.1",browser:{userAgent:c.userAgent||"unknown",platform:c.platform||"unknown"}};b.enabled()?c.plugin="rtc":(c.plugin="flash",c.flash={v:a.getFlashPlayerVersion()});return c}};s["lib/twilio.js"]=function(k,a){a.Device=k("twilio/device").Device;a.EventStream=k("twilio/eventstream").EventStream;a.Connection=k("twilio/connection").Connection;a.require=k};var z="undefined"!=typeof z?z:function(){for(var k=window.location.protocol||
"http:",a="//static.twilio.com/libs/twiliojs/1.0/",f=document.getElementsByTagName("script"),e=/(\w+:)?(\/\/.*)(twilio.min.js|twilio.js)/,d=0;d<f.length;d++){var c=f[d].src.match(e);if(c){k=c[1]||k;a=c[2];break}}return k+a}(),G=z+"WebSocket.swf";window&&(window.WEB_SOCKET_SWF_LOCATION=G);this.JSON||(JSON=function(){function k(a){return 10>a?"0"+a:a}function a(e,d){var c,g,b,h;c=/["\\\x00-\x1f\x7f-\x9f]/g;var l;switch(typeof e){case "string":return c.test(e)?'"'+e.replace(c,function(a){var b=f[a];
if(b)return b;b=a.charCodeAt();return"\\u00"+Math.floor(b/16).toString(16)+(b%16).toString(16)})+'"':'"'+e+'"';case "number":return isFinite(e)?String(e):"null";case "boolean":case "null":return String(e);case "object":if(!e)return"null";if("function"===typeof e.toJSON)return a(e.toJSON());c=[];if("number"===typeof e.length&&!e.propertyIsEnumerable("length")){h=e.length;for(g=0;g<h;g+=1)c.push(a(e[g],d)||"null");return"["+c.join(",")+"]"}if(d){h=d.length;for(g=0;g<h;g+=1)b=d[g],"string"===typeof b&&
(l=a(e[b],d))&&c.push(a(b)+":"+l)}else for(b in e)"string"===typeof b&&(l=a(e[b],d))&&c.push(a(b)+":"+l);return"{"+c.join(",")+"}"}}Date.prototype.toJSON=function(){return this.getUTCFullYear()+"-"+k(this.getUTCMonth()+1)+"-"+k(this.getUTCDate())+"T"+k(this.getUTCHours())+":"+k(this.getUTCMinutes())+":"+k(this.getUTCSeconds())+"Z"};var f={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};return{stringify:a,parse:function(a,d){function c(a,e){var f,g;if(e&&"object"===typeof e)for(f in e)Object.prototype.hasOwnProperty.apply(e,
[f])&&(g=c(f,e[f]),void 0!==g&&(e[f]=g));return d(a,e)}var f;if(/^[\],:{}\s]*$/.test(a.replace(/\\./g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return f=eval("("+a+")"),"function"===typeof d?c("",f):f;throw new SyntaxError("parseJSON");}}}());var A=function(){function k(){if(!H){try{var a=p.getElementsByTagName("body")[0].appendChild(p.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}H=!0;for(var a=N.length,
c=0;c<a;c++)N[c]()}}function a(a){H?a():N[N.length]=a}function f(a){if(typeof w.addEventListener!=u)w.addEventListener("load",a,!1);else if(typeof p.addEventListener!=u)p.addEventListener("load",a,!1);else if(typeof w.attachEvent!=u)s(w,"onload",a);else if("function"==typeof w.onload){var b=w.onload;w.onload=function(){b();a()}}else w.onload=a}function e(){var a=p.getElementsByTagName("body")[0],b=p.createElement(C);b.setAttribute("type",v);var c=a.appendChild(b);if(c){var e=0;(function(){if(typeof c.GetVariable!=
u){var f=c.GetVariable("$version");f&&(f=f.split(" ")[1].split(","),m.pv=[parseInt(f[0],10),parseInt(f[1],10),parseInt(f[2],10)])}else if(10>e){e++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;d()})()}else d()}function d(){var a=E.length;if(0<a)for(var e=0;e<a;e++){var d=E[e].id,f=E[e].callbackFn,l={success:!1,id:d};if(0<m.pv[0]){var k=n(d);if(k)if(q(E[e].swfVersion)&&!(m.wk&&312>m.wk))x(d,!0),f&&(l.success=!0,l.ref=c(d),f(l));else if(E[e].expressInstall&&g()){l={};l.data=E[e].expressInstall;
l.width=k.getAttribute("width")||"0";l.height=k.getAttribute("height")||"0";k.getAttribute("class")&&(l.styleclass=k.getAttribute("class"));k.getAttribute("align")&&(l.align=k.getAttribute("align"));for(var r={},k=k.getElementsByTagName("param"),p=k.length,t=0;t<p;t++)"movie"!=k[t].getAttribute("name").toLowerCase()&&(r[k[t].getAttribute("name")]=k[t].getAttribute("value"));b(l,r,d,f)}else h(k),f&&f(l)}else if(x(d,!0),f){if((d=c(d))&&typeof d.SetVariable!=u)l.success=!0,l.ref=d;f(l)}}}function c(a){var b=
null;if((a=n(a))&&"OBJECT"==a.nodeName)typeof a.SetVariable!=u?b=a:(a=a.getElementsByTagName(C)[0])&&(b=a);return b}function g(){return!O&&q("6.0.65")&&(m.win||m.mac)&&!(m.wk&&312>m.wk)}function b(a,b,c,e){O=!0;G=e||null;L={success:!1,id:c};var d=n(c);if(d){"OBJECT"==d.nodeName?(K=l(d),P=null):(K=d,P=c);a.id=B;if(typeof a.width==u||!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if(typeof a.height==u||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";p.title=p.title.slice(0,
47)+" - Flash Player Installation";e=m.ie&&m.win?"ActiveX":"PlugIn";e="MMredirectURL="+w.location.toString().replace(/&/g,"%26")+"&MMplayerType="+e+"&MMdoctitle="+p.title;b.flashvars=typeof b.flashvars!=u?b.flashvars+("&"+e):e;m.ie&&(m.win&&4!=d.readyState)&&(e=p.createElement("div"),c+="SWFObjectNew",e.setAttribute("id",c),d.parentNode.insertBefore(e,d),d.style.display="none",function(){4==d.readyState?d.parentNode.removeChild(d):setTimeout(arguments.callee,10)}());r(a,b,c)}}function h(a){if(m.ie&&
m.win&&4!=a.readyState){var b=p.createElement("div");a.parentNode.insertBefore(b,a);b.parentNode.replaceChild(l(a),b);a.style.display="none";(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(l(a),a)}function l(a){var b=p.createElement("div");if(m.win&&m.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName(C)[0])if(a=a.childNodes)for(var c=a.length,e=0;e<c;e++)!(1==a[e].nodeType&&"PARAM"==a[e].nodeName)&&8!=a[e].nodeType&&
b.appendChild(a[e].cloneNode(!0));return b}function r(a,b,c){var e,d=n(c);if(m.wk&&312>m.wk)return e;if(d)if(typeof a.id==u&&(a.id=c),m.ie&&m.win){var f="",h;for(h in a)a[h]!=Object.prototype[h]&&("data"==h.toLowerCase()?b.movie=a[h]:"styleclass"==h.toLowerCase()?f+=' class="'+a[h]+'"':"classid"!=h.toLowerCase()&&(f+=" "+h+'="'+a[h]+'"'));h="";for(var g in b)b[g]!=Object.prototype[g]&&(h+='<param name="'+g+'" value="'+b[g]+'" />');d.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+
f+">"+h+"</object>";Q[Q.length]=a.id;e=n(a.id)}else{g=p.createElement(C);g.setAttribute("type",v);for(var l in a)a[l]!=Object.prototype[l]&&("styleclass"==l.toLowerCase()?g.setAttribute("class",a[l]):"classid"!=l.toLowerCase()&&g.setAttribute(l,a[l]));for(f in b)b[f]!=Object.prototype[f]&&"movie"!=f.toLowerCase()&&(a=g,h=f,l=b[f],c=p.createElement("param"),c.setAttribute("name",h),c.setAttribute("value",l),a.appendChild(c));d.parentNode.replaceChild(g,d);e=g}return e}function t(a){var b=n(a);b&&"OBJECT"==
b.nodeName&&(m.ie&&m.win?(b.style.display="none",function(){if(4==b.readyState){var c=n(a);if(c){for(var e in c)"function"==typeof c[e]&&(c[e]=null);c.parentNode.removeChild(c)}}else setTimeout(arguments.callee,10)}()):b.parentNode.removeChild(b))}function n(a){var b=null;try{b=p.getElementById(a)}catch(c){}return b}function s(a,b,c){a.attachEvent(b,c);J[J.length]=[a,b,c]}function q(a){var b=m.pv;a=a.split(".");a[0]=parseInt(a[0],10);a[1]=parseInt(a[1],10)||0;a[2]=parseInt(a[2],10)||0;return b[0]>
a[0]||b[0]==a[0]&&b[1]>a[1]||b[0]==a[0]&&b[1]==a[1]&&b[2]>=a[2]?!0:!1}function y(a,b,c,e){if(!m.ie||!m.mac){var d=p.getElementsByTagName("head")[0];if(d){c=c&&"string"==typeof c?c:"screen";e&&(S=D=null);if(!D||S!=c)e=p.createElement("style"),e.setAttribute("type","text/css"),e.setAttribute("media",c),D=d.appendChild(e),m.ie&&(m.win&&typeof p.styleSheets!=u&&0<p.styleSheets.length)&&(D=p.styleSheets[p.styleSheets.length-1]),S=c;m.ie&&m.win?D&&typeof D.addRule==C&&D.addRule(a,b):D&&typeof p.createTextNode!=
u&&D.appendChild(p.createTextNode(a+" {"+b+"}"))}}}function x(a,b){if(T){var c=b?"visible":"hidden";H&&n(a)?n(a).style.visibility=c:y("#"+a,"visibility:"+c)}}function z(a){return null!=/[\\\"<>\.;]/.exec(a)&&typeof encodeURIComponent!=u?encodeURIComponent(a):a}var u="undefined",C="object",v="application/x-shockwave-flash",B="SWFObjectExprInst",w=window,p=document,F=navigator,I=!1,N=[function(){I?e():d()}],E=[],Q=[],J=[],K,P,G,L,H=!1,O=!1,D,S,T=!0,m=function(){var a=typeof p.getElementById!=u&&typeof p.getElementsByTagName!=
u&&typeof p.createElement!=u,b=F.userAgent.toLowerCase(),c=F.platform.toLowerCase(),e=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1,d=!+"\v1",f=[0,0,0],h=null;if(typeof F.plugins!=u&&typeof F.plugins["Shockwave Flash"]==C){if((h=F.plugins["Shockwave Flash"].description)&&!(typeof F.mimeTypes!=u&&F.mimeTypes[v]&&!F.mimeTypes[v].enabledPlugin))I=!0,d=!1,h=h.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),f[0]=parseInt(h.replace(/^(.*)\..*$/,
"$1"),10),f[1]=parseInt(h.replace(/^.*\.(.*)\s.*$/,"$1"),10),f[2]=/[a-zA-Z]/.test(h)?parseInt(h.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0}else if(typeof w.ActiveXObject!=u)try{var g=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(g&&(h=g.GetVariable("$version")))d=!0,h=h.split(" ")[1].split(","),f=[parseInt(h[0],10),parseInt(h[1],10),parseInt(h[2],10)]}catch(l){}return{w3:a,pv:f,wk:b,ie:d,win:e,mac:c}}();(function(){m.w3&&((typeof p.readyState!=u&&"complete"==p.readyState||typeof p.readyState==
u&&(p.getElementsByTagName("body")[0]||p.body))&&k(),H||(typeof p.addEventListener!=u&&p.addEventListener("DOMContentLoaded",k,!1),m.ie&&m.win&&(p.attachEvent("onreadystatechange",function(){"complete"==p.readyState&&(p.detachEvent("onreadystatechange",arguments.callee),k())}),w==top&&function(){if(!H){try{p.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}k()}}()),m.wk&&function(){H||(/loaded|complete/.test(p.readyState)?k():setTimeout(arguments.callee,0))}(),f(k)))})();
(function(){m.ie&&m.win&&window.attachEvent("onunload",function(){for(var a=J.length,b=0;b<a;b++)J[b][0].detachEvent(J[b][1],J[b][2]);a=Q.length;for(b=0;b<a;b++)t(Q[b]);for(var c in m)m[c]=null;m=null;for(var e in A)A[e]=null;A=null})})();return{registerObject:function(a,b,c,e){if(m.w3&&a&&b){var d={};d.id=a;d.swfVersion=b;d.expressInstall=c;d.callbackFn=e;E[E.length]=d;x(a,!1)}else e&&e({success:!1,id:a})},getObjectById:function(a){if(m.w3)return c(a)},embedSWF:function(c,e,d,f,h,l,k,n,p,t){var s=
{success:!1,id:e};m.w3&&!(m.wk&&312>m.wk)&&c&&e&&d&&f&&h?(x(e,!1),a(function(){d+="";f+="";var a={};if(p&&typeof p===C)for(var m in p)a[m]=p[m];a.data=c;a.width=d;a.height=f;m={};if(n&&typeof n===C)for(var v in n)m[v]=n[v];if(k&&typeof k===C)for(var w in k)m.flashvars=typeof m.flashvars!=u?m.flashvars+("&"+w+"="+k[w]):w+"="+k[w];if(q(h))v=r(a,m,e),a.id==e&&x(e,!0),s.success=!0,s.ref=v;else{if(l&&g()){a.data=l;b(a,m,e,t);return}x(e,!0)}t&&t(s)})):t&&t(s)},switchOffAutoHideShow:function(){T=!1},ua:m,
getFlashPlayerVersion:function(){return{major:m.pv[0],minor:m.pv[1],release:m.pv[2]}},hasFlashPlayerVersion:q,createSWF:function(a,b,c){if(m.w3)return r(a,b,c)},showExpressInstall:function(a,c,e,d){m.w3&&g()&&b(a,c,e,d)},removeSWF:function(a){m.w3&&t(a)},createCSS:function(a,b,c,e){m.w3&&y(a,b,c,e)},addDomLoadEvent:a,addLoadEvent:f,getQueryParamValue:function(a){var b=p.location.search||p.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);if(null==a)return z(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,
b[c].indexOf("="))==a)return z(b[c].substring(b[c].indexOf("=")+1))}return""},expressInstallCallback:function(){if(O){var a=n(B);a&&K&&(a.parentNode.replaceChild(K,a),P&&(x(P,!0),m.ie&&m.win&&(K.style.display="block")),G&&G(L));O=!1}}}}();(function(){if(!window.WebSocket){var k=window.console;if(!k||!k.log||!k.error)k={log:function(){},error:function(){}};A.hasFlashPlayerVersion("10.0.0")?("file:"==location.protocol&&k.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."),
WebSocket=function(a,f,e,d,c){var g=this;g.__id=WebSocket.__nextId++;WebSocket.__instances[g.__id]=g;g.readyState=WebSocket.CONNECTING;g.bufferedAmount=0;g.__events={};setTimeout(function(){WebSocket.__addTask(function(){WebSocket.__flash.create(g.__id,a,f,e||null,d||0,c||null)})},0)},WebSocket.prototype.send=function(a){if(this.readyState==WebSocket.CONNECTING)throw"INVALID_STATE_ERR: Web Socket connection has not been established";a=WebSocket.__flash.send(this.__id,encodeURIComponent(a));if(0>a)return!0;
this.bufferedAmount+=a;return!1},WebSocket.prototype.close=function(){this.readyState==WebSocket.CLOSED||this.readyState==WebSocket.CLOSING||(this.readyState=WebSocket.CLOSING,WebSocket.__addTask(function(){WebSocket.__flash.close(this.__id)}))},WebSocket.prototype.addEventListener=function(a,f,e){a in this.__events||(this.__events[a]=[]);this.__events[a].push(f)},WebSocket.prototype.removeEventListener=function(a,f,e){if(a in this.__events){a=this.__events[a];for(e=a.length-1;0<=e;--e)if(a[e]===
f){a.splice(e,1);break}}},WebSocket.prototype.dispatchEvent=function(a){for(var f=this.__events[a.type]||[],e=0;e<f.length;++e)f[e](a);(f=this["on"+a.type])&&f(a)},WebSocket.prototype.__handleEvent=function(a){"readyState"in a&&(this.readyState=a.readyState);if("open"==a.type||"error"==a.type)a=this.__createSimpleEvent(a.type);else if("close"==a.type)a=this.__createSimpleEvent("close");else if("message"==a.type)a=decodeURIComponent(a.message),a=this.__createMessageEvent("message",a);else throw"unknown event type: "+
a.type;this.dispatchEvent(a)},WebSocket.prototype.__createSimpleEvent=function(a){if(document.createEvent&&window.Event){var f=document.createEvent("Event");f.initEvent(a,!1,!1);return f}return{type:a,bubbles:!1,cancelable:!1}},WebSocket.prototype.__createMessageEvent=function(a,f){if(document.createEvent&&window.MessageEvent&&!window.opera){var e=document.createEvent("MessageEvent");e.initMessageEvent("message",!1,!1,f,null,null,window,null);return e}return{type:a,data:f,bubbles:!1,cancelable:!1}},
WebSocket.CONNECTING=0,WebSocket.OPEN=1,WebSocket.CLOSING=2,WebSocket.CLOSED=3,WebSocket.__flash=null,WebSocket.__instances={},WebSocket.__tasks=[],WebSocket.__nextId=0,WebSocket.loadFlashPolicyFile=function(a){WebSocket.__addTask(function(){WebSocket.__flash.loadManualPolicyFile(a)})},WebSocket.__initialize=function(){if(!WebSocket.__flash)if(document.body)if(WebSocket.__swfLocation&&(window.WEB_SOCKET_SWF_LOCATION=WebSocket.__swfLocation),window.WEB_SOCKET_SWF_LOCATION){var a=document.createElement("div");
a.id="webSocketContainer";a.style.position="absolute";WebSocket.__isFlashLite()?(a.style.left="0px",a.style.top="0px"):(a.style.left="-100px",a.style.top="-100px");var f=document.createElement("div");f.id="webSocketFlash";a.appendChild(f);document.body.appendChild(a);A.embedSWF(G,"webSocketFlash","1","1","10.0.0",null,null,{hasPriority:!0,swliveconnect:!0,allowScriptAccess:"always"},null,function(a){a.success||k.error("[WebSocket] swfobject.embedSWF failed")})}else k.error("[WebSocket] set WEB_SOCKET_SWF_LOCATION to location of WebSocketMain.swf");
else window.addEventListener?window.addEventListener("load",WebSocket.__initialize,!1):window.attachEvent("onload",WebSocket.__initialize)},WebSocket.__onFlashInitialized=function(){setTimeout(function(){WebSocket.__flash=document.getElementById("webSocketFlash");WebSocket.__flash.setCallerUrl(location.href);WebSocket.__flash.setDebug(!!window.WEB_SOCKET_DEBUG);for(var a=0;a<WebSocket.__tasks.length;++a)WebSocket.__tasks[a]();WebSocket.__tasks=[]},0)},WebSocket.__onFlashEvent=function(){setTimeout(function(){try{for(var a=
...
return!a||!a.enabledPlugin||!a.enabledPlugin.filename?!1:a.enabledPlugin.filename.match(/flashlite/i)?!0:!1},window.WEB_SOCKET_DISABLE_AUTO_INITIALIZATION||WebSocket.__initialize()):k.error("Flash Player >= 10.0.0 is required.")}})();(function(k){k.Twilio=k.Twilio||{};k.Twilio._phpjs_atob=function(a){var f,e,d,c,g,b=0,h=0;c="";var l=[];if(!a)return a;a+="";do f="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(b++)),e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(b++)),
c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(b++)),g="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(b++)),d=f<<18|e<<12|c<<6|g,f=d>>16&255,e=d>>8&255,d&=255,64==c?l[h++]=String.fromCharCode(f):64==g?l[h++]=String.fromCharCode(f,e):l[h++]=String.fromCharCode(f,e,d);while(b<a.length);c=l.join("");a=[];f=l=g=h=b=0;for(c+="";b<c.length;)g=c.charCodeAt(b),128>g?(a[h++]=String.fromCharCode(g),b++):191<g&&224>g?(l=c.charCodeAt(b+
1),a[h++]=String.fromCharCode((g&31)<<6|l&63),b+=2):(l=c.charCodeAt(b+1),f=c.charCodeAt(b+2),a[h++]=String.fromCharCode((g&15)<<12|(l&63)<<6|f&63),b+=3);return c=a.join("")};k.Twilio._phpjs_btoa=function(a){var f,e,d,c,g=0,b=0,h="",h=[];if(!a)return a;a+="";if(null===a||"undefined"===typeof a)a="";else{a+="";f="";e=d=c=0;c=a.length;for(var l=0;l<c;l++){var k=a.charCodeAt(l),t=null;128>k?d++:t=127<k&&2048>k?String.fromCharCode(k>>6|192)+String.fromCharCode(k&63|128):String.fromCharCode(k>>12|224)+
String.fromCharCode(k>>6&63|128)+String.fromCharCode(k&63|128);null!==t&&(d>e&&(f+=a.slice(e,d)),f+=t,e=d=l+1)}d>e&&(f+=a.slice(e,c));a=f}do f=a.charCodeAt(g++),e=a.charCodeAt(g++),d=a.charCodeAt(g++),c=f<<16|e<<8|d,f=c>>18&63,e=c>>12&63,d=c>>6&63,c&=63,h[b++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c);
while(g<a.length);h=h.join("");switch(a.length%3){case 1:h=h.slice(0,-2)+"==";break;case 2:h=h.slice(0,-1)+"="}return h}})(window);(function(k){function a(e){if(!(this instanceof a))return new a(e);if("number"!=typeof e||1>e)return null;this.channels=1;this.bitdepth=16;this.samplerate=e;this.sine=[];for(var d=2*Math.PI/parseFloat(e),c=0;c<e;c++)this.sine.push(Math.sin(c*d))}var f={amplify:function(a){return function(d){return d*a}},ushort:function(a){return String.fromCharCode(255&a,255&a>>8)},ulong:function(a){return String.fromCharCode(255&
...
f.map),c=d(function(a){return f.lcm(this.samplerate,a)/a},a),c=f.foldl(f.lcm,c),g=function(a){return function(c){return this.sine[f.mulmod(a,c,this.samplerate)]}};return d(function(b){return f.sum(d(g(b),a))},f.range(c))},encode:function(e,d,c){e=e instanceof Array?e:[e];c=f.compose((c||[]).concat([f.ushort]));e=f.map(c,this.generate(e));c=Math.ceil(d*this.samplerate/e.length);e=Array(c+1).join(e.join("")).substr(0,2*this.samplerate*d);d=["fmt ",f.ulong(a.PCM_CHUNK_SIZE),f.ushort(a.LINEAR_QUANTIZATION),
...
b[c].type+": "+d.message,d,"error")}},0)},__onLog:function(b){"error"==b.level?a.log(b.message,void 0,"error"):a.log(b.message)}},g;for(g in d)a[g]=d[g];for(g in c)a[g]=c[g];a.__nextId=0;a.__flash=null;a.__instances={};a.__tasks=[];a.__debug=!1;a.initialized=!1;a.AMF0=0;a.AMF3=3;k.MediaStream=a})(this.Twilio);var y=document.createElement("audio"),L=!0;try{L=!(y.canPlayType&&y.canPlayType("audio/mpeg").replace(/no/,""))}catch(U){}Twilio.Sound.initialize({swfLocation:z+"SoundMain.swf",forceFlash:L});
var I=B("twilio/device").Device;I.__afterSetup(function(k,a){if(!B("twilio/rtc").enabled()){var f=B("twilio/util").decode,e=B("twilio/factories").getClass("vendor/mediastream/mediastream","MediaStream");e.initialize({objectEnc:e.AMF0,swfLocation:function(a,c){if(!a)return c;var e=c.match(/^(\w+):\/\/([^/]*)(.*)?/);if(!e)return c;var b=e[1],h=e[2],e=e[3];if(!/twilio.com$/.test(h.split(":")[0]))return c;var k=f(a).iss;return!k?c:b+"://"+k.toLowerCase()+"."+h+e}(k,z)+"MediaStreamMain.swf",loader:function(a,
c){I.dialog.insert(a,c)}})}});y=B("twilio");y.Sound=Twilio.Sound;y.MediaStream=Twilio.MediaStream;y._phpjs_atob=Twilio._phpjs_atob;y._phpjs_btoa=Twilio._phpjs_btoa;return y}());
